...
class Livro
{
    ...
    //2° jeito de imprimir os dados
    public function getDados()
    {
        $dados = "Título: " . $this->getTitulo() . "\n";
        $dados .= "Autor: " . $this->getAutor() . "\n";
        $dados .= "Gênero: " . $this->getGenero() . "\n";
        $dados .= "Quantidade Páginas: " . $this->getNroPaginas() . "\n";
        return $dados;
    }

    //3° jeito de imprimir dados
...
/* 1° jeito de imprimir os dados
//Impressão dos dados do livro com mais páginas
echo "\n\n---Dados do livro com mais páginas---\n";
echo "Título: " . $livroMaisPaginas->getTitulo() . "\n";
echo "Autor: " . $livroMaisPaginas->getAutor() . "\n";
echo "Gênero: " . $livroMaisPaginas->getGenero() . "\n";
echo "Quantidade Páginas: " . $livroMaisPaginas->getNroPaginas() . "\n";
*/

/* 2° jeito de imprimir dados
